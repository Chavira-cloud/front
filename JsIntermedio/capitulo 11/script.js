...
/* obtenerInformacion("1: HOLA").then(resultado => console.log(resultado));
obtenerInformacion("").then(resultado => console.log(resultado));
obtenerInformacion("3: 29").then(resultado => console.log(resultado)); */

const mostrarData = async () => {
    data1 = await obtenerInformacion("1: JORGE");
    data2 = await obtenerInformacion("2: MARCO");
    data3 = await obtenerInformacion("3: NORA");
    console.log(data1);
    console.log(data2);
    console.log(data3);
}
